...
Builder = (function() {
  ...
  Builder.prototype.host = function() {
    var files, module, result, _i, _j, _len, _len1, _ref, _ref1;
    this._clear();
  ...
  Builder.prototype.build = function() {
    var destination, manifest_content, manifest_data, module, output, source, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2;
    this._clear();
    this._enlist(this.root);
    _ref = this._modules;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    ...
    if (this.manifest != null) {
      ...
      manifest_content = JSON.stringify(manifest_data, null, this.pretty ? "  " : void 0);
