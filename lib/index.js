...
Builder = (function() {
  function Builder(options) {
    ...
    this.coding_func = (_ref9 = options.coding_func) != null ? _ref9 : "identity";
    this._clear();
  }
  ...
  Builder.prototype.build = function() {
    var destination, manifest_content, manifest_data, module, output, source, start, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2;
    ...
    for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
      ...
      if (destination != null) {
        ...
        this.logger.info("Writing " + destination + ".");
      }
