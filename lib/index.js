var Builder, CyclicDependenciesError, DB, ExternalDependencyError, Logger, Loop, ModuleTypeError, NoCopyingRuleError, UnresolvedDependencyError, clc, crypto, definition, detectiveAMD, detectiveCJS, ejs, encoders, eval_file, fs, get_config_content, globrules, hasBOM, hashers, load_json, load_yaml, packagejson, path, sandbox, vm, walker, yaml, _,
...
Builder = (function() {
  function Builder(options) {
    var name, pattern, template, type, value, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
    ...
    this.hash_func = (_ref7 = options.hash_func) != null ? _ref7 : "md5";
    this.randomize_urls = (_ref8 = options.randomize_urls) != null ? _ref8 : true;
    this.coding_func = options.coding_func;
    this.cache = new DB(path.resolve(this.root, (_ref9 = options.cache_file) != null ? _ref9 : ".spacache"));
    this._clear();
  }
