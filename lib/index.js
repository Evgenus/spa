var Builder, CyclicDependenciesError, DB, ExternalDependencyError, HostingUrlOverwritingError, Logger, Loop, ModuleFileOverwritingError, ModuleTypeError, NoCopyingRuleError, UnresolvedDependencyError, clc, crypto, definition, detectiveAMD, detectiveCJS, ejs, encoders, eval_file, fs, get_config_content, globrules, hasBOM, hashers, load_json, load_yaml, packagejson, path, resolve, sandbox, vm, walker, yaml, _,
...
Builder = (function() {
  ...
  Builder.prototype._host = function() {
    var module, rule, url, urls, _i, _j, _len, _len1, _ref, _ref1, _results;
    urls = {};
    _ref = this._modules;
    _results = [];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
  ...
  Builder.prototype._encode = function() {
    var destination, module, output, paths, source, _i, _j, _len, _len1, _ref, _ref1;
