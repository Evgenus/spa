var Builder, CyclicDependenciesError, DB, ExternalDependencyError, HostingUrlOverwritingError, Logger, Loop, ModuleFileOverwritingError, ModuleTypeError, NoCopyingRuleError, UnresolvedDependencyError, clc, console, crypto, definition, detectiveAMD, detectiveCJS, ejs, encoders, eval_file, fs, get_config_content, globrules, hasBOM, hashers, load_json, load_yaml, packagejson, path, resolve, sandbox, vm, walker, yaml, _,
...
Builder = (function() {
  function Builder(options) {
    var name, pattern, template, type, value, _base, _ref, _ref1, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
    ...
    this.hash_func = (_ref9 = options.hash_func) != null ? _ref9 : "md5";
    this.randomize_urls = (_ref10 = options.randomize_urls) != null ? _ref10 : true;
    this.coding_func = options.coding_func;
    this.cache = this._create_db(path.resolve(this.root, (_ref11 = options.cache_file) != null ? _ref11 : ".spacache"));
  }
