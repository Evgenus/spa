var Builder, CyclicDependenciesError, ExternalDependencyError, Loop, UnresolvedDependencyError, crypto, definition, detectiveAMD, detectiveCJS, ejs, fs, get_config_content, globStringToRegex, load_json, load_yaml, packagejson, path, preg_quote, walk, yaml, _,
...
Builder = (function() {
  function Builder(options) {
    var name, pattern, template, type, value, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
  ...
  Builder.prototype._write_index = function() {
    var assets, compiled, content, fake_builder, filepath, name, namespace, relative, url, value, _ref;
    assets = {};
    namespace = {
      assets: assets
    };
