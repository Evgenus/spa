var Builder, CyclicDependenciesError, ExternalDependencyError, Loop, UnresolvedDependencyError, crypto, detective, ejs, fs, get_config_content, globStringToRegex, load_json, load_yaml, path, preg_quote, walk, yaml, _,
...
Builder = (function() {
  ...
  Builder.prototype._write_index = function() {
    var assets, compiled, content, filename, name, value, _ref;
    assets = {};
    _ref = this.assets;
    for (name in _ref) {
