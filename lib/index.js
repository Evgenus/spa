var Builder, CyclicDependenciesError, ExternalDependencyError, Loop, UnresolvedDependencyError, crypto, detective, fs, get_config_content, globStringToRegex, handlebars, load_json, load_yaml, path, preg_quote, walk, yaml, _,
...
Builder = (function() {
  function Builder(options) {
    var name, pattern, template, value, _ref, _ref1, _ref2, _ref3, _ref4;
    ...
    this.pretty = (_ref3 = options.pretty) != null ? _ref3 : false;
    this.assets = {
  ...
  Builder.prototype._write_index = function() {
    var assets, compiled, content, filename, name, template, value, _ref;
    assets = {};
    _ref = this.assets;
    for (name in _ref) {
