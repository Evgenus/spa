var Builder, CyclicDependenciesError, ExternalDependencyError, Loop, UnresolvedDependencyError, crypto, detective, ejs, fs, get_config_content, globStringToRegex, load_json, load_yaml, make_md5, path, preg_quote, walk, yaml, _,
...
Builder = (function() {
  ...
  Builder.prototype._write_appcache = function() {
    var assets, compiled, content, filename, filepath, relative, template, url;
    assets = {};
    for (filename in this.cached) {
