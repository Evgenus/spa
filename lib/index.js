...
Builder = (function() {
  ...
  Builder.prototype._host = function() {
    var module, rule, _i, _j, _len, _len1, _ref, _ref1, _results;
    _ref = this._modules;
    _results = [];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      module = _ref[_i];
  ...
  Builder.prototype._encode = function() {
    var destination, module, output, source, _i, _j, _len, _len1, _ref, _ref1;
  ...
  Builder.prototype._create_manifest = function() {
    ...
    if (this.coding_func != null) {
      this.manifest_content.decoder_func = this.coding_func.name;
    }
