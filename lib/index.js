var Builder, CyclicDependenciesError, ExternalDependencyError, Loop, UnresolvedDependencyError, crypto, definition, detectiveAMD, detectiveCJS, ejs, fs, get_config_content, globStringToRegex, load_json, load_yaml, path, preg_quote, walk, yaml, _,
