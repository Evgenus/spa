var Builder, CyclicDependenciesError, ExternalDependencyError, Logger, Loop, UnresolvedDependencyError, clc, crypto, definition, detectiveAMD, detectiveCJS, ejs, fs, get_config_content, globrules, hasBOM, load_json, load_yaml, packagejson, path, walker, yaml, _,
...
Builder = (function() {
  ...
  Builder.prototype._write_index = function() {
    ...
    Logger.info("Writing " + filepath + ". " + this._index_content.length + " bytes.");
