var Builder, CyclicDependenciesError, ExternalDependencyError, Loop, UnresolvedDependencyError, crypto, definition, detectiveAMD, detectiveCJS, ejs, fs, get_config_content, globStringToRegex, hash_func, load_json, load_yaml, path, preg_quote, walk, yaml, _,
...
Builder = (function() {
  ...
  Builder.prototype._write_manifest = function() {
    var content, data, filepath, module;
    data = (function() {
      var _i, _len, _ref, _results;
      _ref = this._modules;
      _results = [];
  ...
  Builder.prototype._write_index = function() {
    var assets, compiled, filepath, name, relative, url, value, _ref;
    assets = {};
    _ref = this.assets;
    for (name in _ref) {
  ...
  Builder.prototype._write_appcache = function() {
    ...
    if (this.index != null) {
      ...
      if (url != null) {
        ...
        assets[url] = hash_func(this._index_content);
      }
    }
