var Builder, CyclicDependenciesError, ExternalDependencyError, Logger, Loop, NoCopyingRuleError, UnresolvedDependencyError, clc, crypto, definition, detectiveAMD, detectiveCJS, ejs, encoders, eval_file, fs, get_config_content, globrules, hasBOM, hashers, load_json, load_yaml, packagejson, path, sandbox, vm, walker, yaml, _,
...
Builder = (function() {
  ...
  Builder.prototype.encode = function(content, module) {
    var data, encoder, result;
    encoder = encoders[this.coding_func.name];
    result = {
      iter: this.coding_func.iter,
      ks: this.coding_func.ks,
      ts: this.coding_func.ts,
      auth: module.url
    };
    data = encoder(content, this.coding_func.password, result);
  ...
  Builder.prototype._create_manifest = function() {
    ...
    manifest = {
      ...
      decoder_func: this.coding_func != null ? this.coding_func.name : "identity",
      modules: modules
    };
    return manifest;
  };
