...
var Builder, CyclicDependenciesError, ExternalDependencyError, Loop, UnresolvedDependencyError, crypto, detective, fs, globStringToRegex, path, preg_quote, walk, _,
...
CyclicDependenciesError = (function(_super) {
  ...
  function CyclicDependenciesError(_loop) {
    this._loop = _loop;
...
Loop = (function() {
  function Loop(path, alias) {
    this._parts = [[path, alias]];
  }
...
Builder = (function() {
  function Builder(options) {
    ...
    this.manifest = (_ref3 = options.manifest) != null ? _ref3 : "manifest.json";
    this._clear();
  }
    ...
    for (_i = 0, _len = candidates.length; _i < _len; _i++) {
      ...
      _go_deep = function(current) {
        ...
        for (alias in deps) {
          ...
          if (dep === candidate) {
            return new Loop(relative, alias);
          }
          walked.push(dep);
          deep = _go_deep(dep);
          walked.pop();
