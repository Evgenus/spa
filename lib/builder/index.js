...
Builder = (function() {
  ...
  Builder.prototype._find_loop = function(candidates) {
    ...
    for (_i = 0, _len = candidates.length; _i < _len; _i++) {
      ...
      _go_deep = function(current) {
        var alias, deep, dep, deps, module;
        ...
        for (alias in deps) {
          ...
          if (dep === candidate) {
            return module.relative + " --[" + alias + "]--> " + _this._by_path[candidate].relative;
          }
          walked.push(dep);
          deep = _go_deep(dep);
          walked.pop();
  ...
  Builder.prototype._sort = function() {
    ...
    while (left.length > 0) {
      ...
      if (use.length === 0) {
        throw new Error("Can't sort modules. Loop found: " + this._find_loop(left));
      }
