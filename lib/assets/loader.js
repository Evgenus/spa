...
Loader = (function() {
  ...
  Loader.prototype.write_fake = function() {
    var manifest;
    manifest = JSON.parse(FAKE_MANIFEST);
    this.set("spa::manifest", FAKE_MANIFEST);
    return this.set("spa:" + manifest[0].md5 + ":" + manifest[0].url, FAKE_APP);
  };

  Loader.prototype.start = function() {
    var alias, dep, deps, error, evaluator, module, module_source, _i, _len, _ref, _ref1, _ref2;
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      deps["loader"] = this;
      evaluator = new this._evaluators[(_ref2 = module.type) != null ? _ref2 : "cjs"]({
        id: module.id,
