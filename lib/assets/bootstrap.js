...
loader.onNoManifest = function(error) {
  ...
  loader.onModuleDownloadFailed = function(event, module, error) {
    var el, _ref, _ref1;
    log("onModuleDownloadFailed", event, module);
    malfunction.report((_ref = ("Error while downloading module `" + module.id + "` from url `" + module.url + "`: ") + (event != null ? (_ref1 = event.target) != null ? _ref1.statusText : void 0 : void 0)) != null ? _ref : error);
    el = $("#module-" + module.id);
    el.find(".state").addClass("hide");
